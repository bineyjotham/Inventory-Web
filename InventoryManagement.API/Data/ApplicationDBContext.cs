    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        private void SeedData(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Supplier>().HasData(
                new Supplier { Id = 1, Name = "TechParts Inc.", ContactPerson = "John Smith", Email = "john@techparts.com", Phone = "+1 (555) 123-4567", Status = "active", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, Address = "20 Dromo lane" },
                new Supplier { Id = 2, Name = "Office Supply Co.", ContactPerson = "Sarah Johnson", Email = "sarah@officesupply.com", Phone = "+1 (555) 987-6543", Status = "active", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, Address = "45 Paper Street" }
            );
        }
    }
}